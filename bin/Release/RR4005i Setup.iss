...
; Generated by Eor Equis on 11/12/2019 (UTC)
;
[Setup]
AppID={{0b93bb91-2f50-4bac-8cc6-81f1667b02f0}
AppName=ASCOM RR4005i Switch Driver
AppVerName=ASCOM RR4005i Switch Driver 0.2.51
AppVersion=0.2.51
...
OutputDir="."
OutputBaseFilename="RR4005i Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\RR4005i"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\RR4005i"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "D:\Dev\Git\RR4005i Switch\bin\Release\RR4005i Switch.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "D:\Dev\Git\RR4005i Switch\README.txt"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\RR4005i Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\RR4005i Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\RR4005i Switch.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\RR4005i Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\RR4005i Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
